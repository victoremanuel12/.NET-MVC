...
namespace MVC2022.Areas.Admin.Controllers
{
    ...
    public class AdminLanchesController : Controller
    {
        ...
        // GET: Admin/AdminLanches(sem filtro e paginação)
        ...
        public async Task<IActionResult> Create([Bind("LancheId,LancheNome,LancheDescricaoCurta,LancheDescricaoDetalhada,LanchePreco,LancheImagemUrl,LancheImagemThumbnailUrl,IsLanchePreferido,EmEstoque,CategoriaId")] Lanche lanche)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LancheId,LancheNome,LancheDescricaoCurta,LancheDescricaoDetalhada,LanchePreco,LancheImagemUrl,LancheImagemThumbnailUrl,IsLanchePreferido,EmEstoque,CategoriaId")] Lanche lanche)
        {
